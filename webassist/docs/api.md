...
| Windows names | Запрещены `CON`, `PRN`, `AUX`, `NUL`, `CLOCK# REST API WebAssistant
...
, `COM1..9`, `LPT1..9`, invalid chars и trailing dot/space. | platform | Windows namespace | `400 filesystem_path_invalid`. | Windows | inherited |
